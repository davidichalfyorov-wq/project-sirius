...
OFF_INI="volumetric_nebula = false
volumetric_nebulae = false
volumetric_quality = 2
volumetric_composite = false
volumetric_temporal = false
volumetric_reprojection = false
volumetric_blue_noise = false
volumetric_adaptive_quality = false
volumetric_near_cascade = false
volumetric_near_composite = false
volumetric_near_detail = false
volumetric_ship_displacement = false
volumetric_wake_history = false
volumetric_wake_curl = false
volumetric_god_rays = false
volumetric_material_fog = false
volumetric_lightning_channels = false
volumetric_lightning_deterministic = false
volumetric_lightning_golden_disable = false
atmosphere_luts = false
atmosphere_aerial = false
atmosphere_cloud_shell = false
rt_shadows = false
rtao = false
rt_reflections = false
shadows = true"
