    ...
    string? VolumetricOpenVdbManifest = null)
{
    ...
    private static RenderDebugView ParseDebugView(string? value) =>
        (value ?? "off").Trim().ToLowerInvariant() switch
        {
            ...
            "vol_self_shadow" or "volselfshadow" or "self_shadow" or "selfshadow" or "vol_shadowing" => RenderDebugView.VolumetricSelfShadow,
            ...
            "vol_openvdb" or "volopenvdb" or "openvdb" or "vol_imported_density" or "imported_density" => RenderDebugView.VolumetricOpenVdb,
