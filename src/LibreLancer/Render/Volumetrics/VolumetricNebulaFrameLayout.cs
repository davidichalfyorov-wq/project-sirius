...
/// <summary>
/// Production-facing Phase 5 quality profile. PR-5.2 only allocates the froxel
/// textures, but the contract already reserves the fields needed by later density,
/// lighting, temporal, near-cascade, displacement and atmosphere passes so the
/// renderer does not grow into a one-off Li01 demo.
/// </summary>
    ...
    [
        new(VolumetricNebulaPassSlot.Allocate, "vol_nebula_allocate", [],
            [VolumetricNebulaResourceSlot.MainDensity, VolumetricNebulaResourceSlot.MainLighting,
             VolumetricNebulaResourceSlot.MainIntegratedScatteringTransmittance, VolumetricNebulaResourceSlot.MainHistory], false),
        new(VolumetricNebulaPassSlot.ClearIdentity, "vol_nebula_clear", [],
            [VolumetricNebulaResourceSlot.MainDensity, VolumetricNebulaResourceSlot.MainLighting,
             VolumetricNebulaResourceSlot.MainIntegratedScatteringTransmittance, VolumetricNebulaResourceSlot.MainHistory], false),
        new(VolumetricNebulaPassSlot.InjectDensity, "vol_nebula_density", [VolumetricNebulaResourceSlot.BlueNoise],
            [VolumetricNebulaResourceSlot.MainDensity], true),
        ...
        new(VolumetricNebulaPassSlot.Integrate, "vol_nebula_integrate", [VolumetricNebulaResourceSlot.MainDensity, VolumetricNebulaResourceSlot.MainLighting],
            [VolumetricNebulaResourceSlot.MainIntegratedScatteringTransmittance], true),
        ...
        new(VolumetricNebulaPassSlot.DebugView, "vol_nebula_debug", [VolumetricNebulaResourceSlot.MainDensity, VolumetricNebulaResourceSlot.MainIntegratedScatteringTransmittance], [], true),
