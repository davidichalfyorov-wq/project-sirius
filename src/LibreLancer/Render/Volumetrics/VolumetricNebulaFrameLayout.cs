    ...
    bool StubInPr52)
{
    ...
    [
        ...
        new(VolumetricNebulaPassSlot.DepthCopy, "vol_nebula_depth_copy", [],
            [VolumetricNebulaResourceSlot.SceneDepthCopy], true),
        new(VolumetricNebulaPassSlot.TemporalReproject, "vol_nebula_reproject", [VolumetricNebulaResourceSlot.MainIntegratedScatteringTransmittance,
             VolumetricNebulaResourceSlot.MainHistory, VolumetricNebulaResourceSlot.SceneDepthCopy],
        ...
        new(VolumetricNebulaPassSlot.Composite, "vol_nebula_composite", [VolumetricNebulaResourceSlot.MainIntegratedScatteringTransmittance,
             VolumetricNebulaResourceSlot.SceneDepthCopy], [], true),
        ...
        new(VolumetricNebulaPassSlot.DebugView, "vol_nebula_debug_view", [VolumetricNebulaResourceSlot.MainDensity,
