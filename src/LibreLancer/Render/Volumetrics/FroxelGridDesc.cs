    ...
    bool TemporalHistory)
{
        ...
        float NearFar)
    {
        public static FroxelQualityPreset FromQuality(int quality)
        {
            ...
            return q switch
            {
                0 => new FroxelQualityPreset(0, 0.20f, 32, 100_000f, 0.30f, 40, 450f),
                1 => new FroxelQualityPreset(1, 0.25f, 48, 120_000f, 0.40f, 48, 520f),
                3 => new FroxelQualityPreset(3, 0.50f, 96, 180_000f, 0.75f, 80, 700f),
                _ => new FroxelQualityPreset(2, 0.33f, 64, 150_000f, 0.55f, 64, 620f)
            };
        }
    }
}
